...
public class Tests
{
    ...
    {
        Assert.Equal(13140, Solution.Part1(Example));
    }

    [Fact]
    public void Test_Part2_Example()
    {
        var r = Solution.Part2(Example).ToList();
        Assert.Equal(Part2_ExampleOutput.Length, r.Count);
        foreach (var (line, i) in r.Select((x, i) => (x, i)))
        {
            Assert.Equal(Part2_ExampleOutput[i], line);
        }
    }
    ...
    private readonly string[] Part2_ExampleOutput =
    {
        "##..##..##..##..##..##..##..##..##..##..",
        "###...###...###...###...###...###...###.",
        "####....####....####....####....####....",
